...
import { Unit, Value } from '../../../../reporter/models/measures/unit';
import { DistanceUnit } from '../../../../reporter/models/measures/units/distance';
import { TemperatureUnit } from '../../../../reporter/models/measures/units/temperature';
import { SpeedUnit } from '../../../../reporter/models/measures/units/speed';
import { PercentUnit } from '../../../../reporter/models/measures/units/percent';
import {
    AirQualityData,
    AirQualityMetric,
    BuoyReading,
...
import { PressureUnit } from '../../../../reporter/models/measures/units/pressure';
import { DirectionUnit } from '../../../../reporter/models/measures/units/direction';
import customParseFormat from 'dayjs/plugin/customParseFormat';
import { TimeUnit } from '../../../../reporter/models/measures/units/time';
    ...
    toOceanConditions(apiResponse: any): OceanConditions {
        ...
        for (let i = 2; i < lines.length; i++) {
            ...
            const reading: BuoyReading = {
                ...
                airTemperature: Value.fromString(
                    parts[13],
                    TemperatureUnit.fromSymbol(unitsLine[13])
                )!,
                waterTemperature: Value.fromString(
                    parts[14],
                    TemperatureUnit.fromSymbol(unitsLine[14])
                )!,
